...
url = "https://www.washingtonpost.com/elections/election-results/nevada-2020/"
...
if biden_diff == 0 and trump_diff == 0:
    ...
    rangeVal = 'NV!A' + str(rowNum) + ':C' + str(rowNum)
